...
export default function AdminBookingsPage() {
  ...
  }, [page, status, kind, debouncedSearch]);
        ...
        <CardHeader className="pb-0">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="relative flex-1">
              ...
              <Input
                className="pl-9"
                placeholder="Search user, email, or enterprise…"
                value={search}
                ...
                {isInitialLoad ? (
                  ...
                  data?.items.map((booking) => (
                    <tr key={booking.id}>
                      ...
                      <td className="px-6 py-3">
                        <span
                          className={`rounded px-2 py-0.5 text-xs font-medium capitalize ${statusBadgeClass(booking.status)}`}
                        >
                          {booking.status}
                        </span>
                      </td>
                      <td className="px-6 py-3 hidden sm:table-cell">
                        <span
                          className={`rounded px-2 py-0.5 text-xs font-medium capitalize ${paymentBadgeClass(booking.paymentStatus)}`}
                        >
